package com.zaqbest.base.comm.utils;
...
//                WebLogIgnore ann = _findAnnotation(m, WebLogIgnore.class);
//                return ann != null;
//            }
//        });
//    }
     ...
     * @return
     */
    public static String mapToJson(Map map, ObjectMapper objectMapper) {
        try {
            return objectMapper.writeValueAsString(map);
        } catch (Exception e) {
            e.printStackTrace();
